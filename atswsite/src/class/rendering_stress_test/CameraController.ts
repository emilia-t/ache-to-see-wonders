// The relative position of this file: src/class/rendering_stress_test/CameraController.ts
// Code name:RH3
...
import { sceneConfig, cameraConfig, rendererConfig, lightConfig } from '@/config/renderingStressTestConfig.ts';
