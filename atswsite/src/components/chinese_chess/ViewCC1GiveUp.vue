...
// The relative position of this file: src/components/ViewCC1GiveUp.vue
...
const emit = defineEmits<{
  'click-give-up': [value: boolean]
}>();

// 方法
const handleClick = () => {
  emit('click-give-up', props.giveUpState);
};
