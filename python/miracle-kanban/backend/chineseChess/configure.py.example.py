#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# The relative position of this file: /backend/chineseChess/configure.py.example.py
...
_config_anonymous_login_            = False     # 是否允许匿名登录
_config_server_key_                 = 'cc1'     # 服务器键名
_config_server_name_                = 'cName'   # 服务器名称
...
if _config_environment_ == 'development':
    # 开发环境配置
    _config_host_                   = 'localhost'           # 服务器地址
    _config_port_                   = 2424                  # 服务器端口
    _config_server_url_             = f'ws://{_config_host_}:{_config_port_}'
    _api_account_server_url_        = 'http://localhost:810'# 账号服务器地址
    _access_control_allow_origin_   = None                  # 开发环境允许所有跨域请求
    ...
    if _config_ssl_cert_file_ and _config_ssl_key_file_ and os.path.exists(_config_ssl_cert_file_) and os.path.exists(_config_ssl_key_file_):
        ...
        _config_use_ssl_            = True
        _config_server_url_         = 'wss://example.com:2424'  # 生产环境使用wss
    ...
    _access_control_allow_origin_ = None